 ...
 * @date 2013-10-17
 */
public class MenuManagerQskh {
	private static Logger log = LoggerFactory.getLogger(MenuManagerQskh.class);
	...
	public static void main(String[] args) {
		...
		//青松
		String appId = "wx6e96f03580b1da7c";
		// 第三方用户唯一凭证密钥
		
		String appSecret ="f82a2bf5cd96eeca0cbbc238a6bddb3c";
...
//			                "}";
						       ...
						       "}," 
						          ...
						          "\"name\":\"检测结果\","+
						           ...
						           "},"
									...
									"\"name\":\"注册\","+
										"\"type\":\"view\","+
										"\"url\":\"http://foncti.qskh.cn/toQSKHRegister\""+
									"}," +
	 					       "]"+
			                "}";
		...
		String abcdrepairLangstrwefewfwfw =	"{" +
				"\"button\":["+
								"{"+
						          "\"name\":\"登录\","+
									"\"type\":\"view\","+
									 ...
									 "["+
									     "{"+
									      ...
									      "{"+
									        "\"type\":\"view\","+
									         "\"name\":\"二维码\","+
									         "\"url\":\"http://foncti.qskh.cn/myQRCodePinetreeCare\""+
									        "}," +
									  "]" +
	                             "}," +
			                  "]"+
			...
			System.out.println(abcdrepairLangstrwefewfwfw);
			boolean result = MenuUtil.createMenu(abcdrepairLangstrwefewfwfw, token.getAccessToken());
